    ...
    <footer className="relative pt-24 pb-12 overflow-hidden border-t border-slate-300 mt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-4 gap-12 items-start mb-16">
              ...
              {['About', 'Expertise', 'Skills', 'Services', 'Projects', 'Certifications', 'Contact'].map((item) => (
                <li key={item}>
                  <a
                    ...
                    className="text-slate-800 hover:text-primary-600 hover:translate-x-2 transition-all block flex items-center gap-2 group font-bold"
                  >
          ...
          {/* Social Uplinks */}
          <div>
            <h3 className="font-mono text-sm text-primary-700 mb-6 uppercase tracking-widest font-bold underline decoration-primary-500/30">Connect_Uplink</h3>
              ...
              {socialLinks.map((social) => (
                <MagneticButton key={social.label}>
                  <a
                    ...
                    className="p-3 bg-black/5 border border-black/10 rounded-lg hover:bg-black/10 hover:border-primary-600 transition-all group block shadow-sm backdrop-blur-md"
                  >
                    <social.icon size={20} className="text-slate-900 group-hover:text-primary-600 transition-colors" />
                  </a>
                </MagneticButton>
              ))}
            </div>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <MagneticButton>
          <motion.button
            ...
            className="p-4 bg-primary-600/30 backdrop-blur-md border border-primary-500/50 text-slate-900 rounded-full hover:bg-primary-600 hover:text-white hover:border-primary-500 transition-all shadow-[0_0_20px_rgba(137,166,127,0.3)] group"
          >
